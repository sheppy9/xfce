...
xfconf-query -c xfce4-keyboard-shortcuts -t 'string' -np '/commands/custom/<Super>k' -s 'keepassxc'
...
xfconf-query -c xfce4-keyboard-shortcuts -t 'string' -np '/commands/custom/<Super>w' -s 'exo-open --launch WebBrowser'
